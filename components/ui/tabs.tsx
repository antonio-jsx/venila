  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-[state=active]:bg-background data-[state=active]:text-foreground dark:data-[state=active]:border dark:data-[state=active]:bg-black/30 dark:data-[state=active]:text-foreground',
